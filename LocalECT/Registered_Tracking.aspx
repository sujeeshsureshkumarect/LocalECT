<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registered_Tracking.aspx.cs" Inherits="LocalECT.Registered_Tracking" MasterPageFile="~/LocalECT.Master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>
                        <a href="#">&nbsp;Accounting /</a>
                      <a href="Registered_Tracking">&nbsp;Registered Tracking </a>
                    </h3>
                </div>
                <style>
                    .breadcrumb {
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-bar-chart"></i> Registered Tracking</h2>
