...
namespace LocalECT
{
  public partial class Digital_Transformation_Create : System.Web.UI.Page
  {
    ...
    {
      SqlCommand cmd = new SqlCommand("insert into CS_Digital_Transformation_Program values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
      cmd.Parameters.AddWithValue("@sProg", txt_Program.Text.Trim());
      ...
      try
      {
        ...
        lbl_Msg.Text = "Digital Transformation Program Created Successfully ";
