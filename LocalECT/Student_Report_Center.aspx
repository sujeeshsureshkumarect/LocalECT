                        ...
                        <div class="x_content">
                            ...
                            <div id="Headers">
                                <div class="row">  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <asp:DropDownList ID="drp_Type" runat="server" CssClass="form-control">
                                                    <asp:ListItem Text="Registered" Value="Registered" Selected="True"></asp:ListItem>
                                                    <asp:ListItem Text="Unregistered" Value="Unregistered"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="x_panel">   
                                         <div class="x_title">
                            <h2><i class="fa fa-info"></i> Choose your fields (Maximum 15 Fields)</h2>                         
                            <div class="clearfix"></div>
                        </div>
                                    <asp:CheckBoxList id="chk_Fields" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CellPadding="5">
                                        ...
                                        <asp:ListItem Text="EmSAT_AR" Value="SD.EmSAT_AR"></asp:ListItem>
