<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ACC_Adjustments.aspx.cs" Inherits="LocalECT.Acc_Adjustments" MasterPageFile="~/LocalECT.Master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>
                        <a href="#">&nbsp;Accounting /</a>
                      <a href="ACC_Adjustments">&nbsp;Adjustments </a>
                    </h3>
                </div>
                <style>
                    .breadcrumb {
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-bar-chart"></i> Adjustments</h2>
                                ...
                                <div class="row">  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <asp:DropDownList ID="ddlRptType" runat="server" CssClass="form-control">
                                                  <asp:ListItem Value="0">Fees</asp:ListItem>
                                  ...
                                  <div class="col-sm-2 col-md-2 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                 <asp:DropDownList ID="ddlCreated" runat="server" CssClass="form-control">
                                                 <asp:ListItem Value="0">System</asp:ListItem>
