...
namespace LocalECT
{
    public partial class CS_Initiative_Priority_Create : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_Initiative_Priority values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
            ...
            try
            {
                ...
                lbl_Msg.Text = "Initiative Priority Created Successfully ";
                div_msg.Visible = true;
