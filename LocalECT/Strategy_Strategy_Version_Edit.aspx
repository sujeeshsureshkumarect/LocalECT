<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategy_Version_Edit.aspx.cs" Inherits="LocalECT.CS_Strategy_Version_Edit" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-plus"></i> Strategy Version </h2>
                                    ...
                                    <div class="alert alert-success alert-dismissible " role="alert" runat="server" id="div_Alert">
                                        ...
                                        <asp:Label ID="lbl_Msg" runat="server" Text="Strategy Version Updated Successfully" Visible="true" Font-Bold="true" Font-Size="16px"></asp:Label>
                                    </div>
                                </div>
                    <div class="col-md-12 col-sm-12">
                                                 ...
                                                 <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="*MStrategy Version Required" ControlToValidate="txt_Version" ForeColor="Red" ValidationGroup="no">
                       ...
                       <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="* equired" ControlToValidate="txt_eDate" ForeColor="Red" ValidationGroup="no">
                                                    </asp:RequiredFieldValidator>
                                                </div> </div>
                                                       <div class="col-md-6 col-sm-6">
                                                      <div class="form-group ">
