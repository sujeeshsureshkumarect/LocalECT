<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CHEDS_New_Applicants.aspx.cs" Inherits="LocalECT.CHEDS_New_Applicants" MasterPageFile="~/LocalECT.Master"%>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>
                        <a href="CHEDS_New_Applicants">&nbsp;CHEDS New Applicants</a>
                    </h3>
                </div>
                <style>
                    .breadcrumb {
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-calendar"></i> CHEDS New Applicants</h2>
