<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategy_Version.aspx.cs" Inherits="LocalECT.CS_Strategy_Version"  MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-dashboard"></i> Strategy Version</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                               <a href="Strategy_Strategy_Version_Create" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New Strategy Version</a>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Strategy Version</th>
                                             ...
                                             <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Is Active</th>
                                                   ...
                                                   <td><%#Eval("iOrder")%></td>
                                                    ...
                                                    <div class="btn-group" style="text-align:center">
                                                         ...
                                                         <div class="dropdown-menu" >                                                             
                                                            <a href="Strategy_Strategy_Version_Edit.aspx?id=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
