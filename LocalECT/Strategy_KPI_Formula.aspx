<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_KPI_Formula.aspx.cs" Inherits="LocalECT.CS_KPI_Formula" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-dashboard"></i> KPI Formula</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                               <a href="Strategy_KPI_Formula_Create" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New KPI Formula</a>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">KPI Formula</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group" style="text-align:center">
                                                         ...
                                                         <div class="dropdown-menu" >                                                             
                                                            <a href="Strategy_KPI_Formula_Edit.aspx?id=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
