                                        ...
                                        <div class="x_title">
                                            ...
                                            <ul class="nav navbar-right panel_toolbox">
                                                ...
                                                <%--<a href="Strategy_SubStipulation_Home.aspx" style="float:right;" class="btn btn-success btn-sm" title="Back"><i class="fa fa-arrow-circle-left"></i> Sub Stipulation</a>--%>
                                                 <asp:LinkButton ID="LinkButton1" runat="server" style="float:right;" CssClass="btn btn-success btn-sm" OnClick="LinkButton1_Click"><i class="fa fa-arrow-circle-left"></i> Inspection Compliance Indicator</asp:LinkButton>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_Inspection_Compliance_Guidelines_Update.aspx?sid=<%#Eval("iInspectionComplianceStandard")%>&did=<%#Eval("iInspectionComplianceDomain")%>&iid=<%#Eval("iInspectionComplianceIndicator")%>&gid=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>                                                             
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
