...
namespace LocalECT
{
  public partial class CS_IRQA_Recommendation_Create : System.Web.UI.Page
  {
    ...
    {
      SqlCommand cmd = new SqlCommand("insert into CS_IRQA_Recommendation values(@sRec,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
