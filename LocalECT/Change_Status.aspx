<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change_Status.aspx.cs" Inherits="LocalECT.Change_Status" MasterPageFile="~/LocalECT.Master" MaintainScrollPositionOnPostback="true"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-exclamation"></i> Change Status</h2>
                            ...
                            <strong>Selected Student ID - </strong><asp:Label runat="server" ID="lbl_IDs" ClientIDMode="Static"></asp:Label>
                                            ...
                                            <div class="col-md-12">
                                                <hr />
                                                 <asp:LinkButton ID="lnk_BulkUpdate" runat="server" CssClass="btn btn-success btn-sm" OnClientClick="return confirm('Are you sure to proceed with this operation (Change Status)?')" ValidationGroup="no" OnClick="lnk_BulkUpdate_Click"><i class="fa fa-upload"></i> Update</asp:LinkButton>
                                            </div>                                           
