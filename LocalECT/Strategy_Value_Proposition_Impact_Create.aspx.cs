...
namespace LocalECT
{
    public partial class CS_Value_Proposition_Impact_Create : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_Value_Proposition_Impact values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
            ...
            try
            {
                ...
                lbl_Msg.Text = "Value Proposition Impact Created Successfully ";
                div_msg.Visible = true;
