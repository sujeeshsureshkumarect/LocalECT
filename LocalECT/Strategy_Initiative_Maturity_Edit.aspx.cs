...
namespace LocalECT
{
    public partial class CS_Initiative_Maturity_Edit : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from CS_Initiative_Maturity  where iSerial=@iLink", sc);
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    txt_Maturity.Text = dt.Rows[0]["sInitiativeMaturity"].ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("update CS_Initiative_Maturity set sInitiativeMaturity=@sProg,dUpdated=@dAdded,sUpdatedBy=@sAddedby where iSerial=@iLink", sc);

            cmd.Parameters.AddWithValue("@sProg", txt_Maturity.Text.Trim());
        ...
        {
            Response.Redirect("Strategy_Initiative_Maturity");
        }
    }
}
