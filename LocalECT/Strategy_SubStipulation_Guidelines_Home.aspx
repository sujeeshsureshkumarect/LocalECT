<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_SubStipulation_Guidelines_Home.aspx.cs" Inherits="LocalECT.Strategy_SubStipulation_Guidelines_Home" MasterPageFile="~/LocalECT.Master"%>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_SubStipulation_Guidelines_Update.aspx?id=<%#Eval("iStipulation")%>&sid=<%#Eval("iSubStipulation")%>&gid=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>                                                             
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
