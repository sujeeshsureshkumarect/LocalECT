...
namespace LocalECT
{
    public partial class CS_Market_Positioning_Pillars_Create : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_Market_Positioning_Pillars values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
            ...
            try
            {
                ...
                lbl_Msg.Text = "Market Positioning Pillars Created Successfully ";
                div_msg.Visible = true;
