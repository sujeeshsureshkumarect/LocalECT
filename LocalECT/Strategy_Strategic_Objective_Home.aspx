<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_Objective_Home.aspx.cs" Inherits="LocalECT.Strategy_Strategic_Objective_Home" MasterPageFile="~/LocalECT.Master"%>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Objective ID</th>                                                                                        
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Objective Desc</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Strategic Project ID</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%#Eval("sStrategicObjectiveDesc")%></td>
