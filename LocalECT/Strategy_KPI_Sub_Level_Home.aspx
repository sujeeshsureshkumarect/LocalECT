<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_KPI_Sub_Level_Home.aspx.cs" Inherits="LocalECT.Strategy_KPI_Sub_Level_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> KPI Sub Level</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                ...
                                                <a href="Strategy_KPI_Level_Home.aspx" style="float:right;" class="btn btn-success btn-sm" title="Back"><i class="fa fa-arrow-circle-left"></i> KPI Level</a>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" width="300px">KPI Level</th>                                                                                       
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_KPI_Sub_Level_Update.aspx?id=<%#Eval("iKPILevel")%>&sid=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>                                                                                                                     
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
