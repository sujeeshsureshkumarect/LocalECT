...
namespace LocalECT
{
    public partial class CS_MOE_Classification_Pillars_Create : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_MOE_Classification_Pillars values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
            ...
            try
            {
                ...
                lbl_Msg.Text = "MOE Classification Pillars Created Successfully ";
                div_msg.Visible = true;
