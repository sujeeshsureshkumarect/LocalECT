...
namespace LocalECT
{
    public partial class HR_Official_Letter_Form : System.Web.UI.Page
    {
        ...
        public void sentdatatoSPLIst()
        {
            ...
            myItem["Contact"] = Mobile.Text;
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + "/" + lbl_ServiceNameAr.Text + "<br/><b>Letter Language:</b>" + LetterLang.SelectedItem.Text + "<br/><b>Purpose:</b> " + Purpose.Text + "<br/><b>To Whom:</b> " + ToWhom.Text + "<br/><b>Mobile:</b> " + Mobile.Text + "<br/><b>Contact No:</b> " + "<br/><b>Signature:</b>" + Signature.Text + "<br/><b>Date:</b>" + txt_Date.Text + "<br/>";
        ...
        //                Approvals.Value = "Dept Head Approval,Dean Approval,Provost Approval,HR Approval";
        //            }
        //            else
        //            {
        //                Approvers.Value = dt.Rows[0]["HOD_Email"].ToString() + "," + dt.Rows[0]["HRManagerEmail"].ToString();
        //                Approvals.Value = "Dept Head Approval,HR Approval";
        //            }
        ...
        public void approvalDetails()
        {
            ...
            try
            {
                ...
                //    if (IsFaculty == "Yes")
                //    {
                //        Approvers.Value = dt.Rows[0]["HOD_Email"].ToString() + "," + dt.Rows[0]["Dean_Email"].ToString() + "," + dt.Rows[0]["ProvostEmail"].ToString() + "," + hostmail + "," + dt.Rows[0]["HRManagerEmail"].ToString();
                //        Approvals.Value = "Dept Head Approval,Dean Approval,Provost Approval,HR Representative Approval,HR Head Approval";
                //    }
                //    else
                //    {
                //        Approvers.Value = dt.Rows[0]["HOD_Email"].ToString() + "," + hostmail + "," + dt.Rows[0]["HRManagerEmail"].ToString();
                //        Approvals.Value = "Dept Head Approval,HR Representative Approval,HR Head Approval";
                //    }
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        Approvers.Value = hostmail + "," + dt.Rows[0]["HRManagerEmail"].ToString();
                        Approvals.Value = "HR Representative Approval,HR Head Approval";
                    }
                    ...
                    else if (mymail == hodmail)
                    {
                        ...
                        if (hodmail == deanmail)
                        {
                            ...
                            if (IsFaculty == "Yes")
                            {
                                Approvers.Value = dt.Rows[0]["ProvostEmail"].ToString() + "," + hostmail + "," + dt.Rows[0]["HRManagerEmail"].ToString();
                                Approvals.Value = "Provost Approval,HR Representative Approval,HR Head Approval";
                            }
                            else
                            {
                                Approvers.Value = presidentmail + "," + hostmail + "," + dt.Rows[0]["HRManagerEmail"].ToString();
                        ...
                        else
                        {
                            ...
                            if (IsFaculty == "Yes")
                            {
                                Approvers.Value = dt.Rows[0]["Dean_Email"].ToString() + "," + dt.Rows[0]["ProvostEmail"].ToString() + "," + hostmail + "," + dt.Rows[0]["HRManagerEmail"].ToString();
                                Approvals.Value = "Dean Approval,Provost Approval,HR Representative Approval,HR Head Approval";
                            }
                            else
                            {
                                Approvers.Value = dt.Rows[0]["Dean_Email"].ToString() + "," + hostmail + "," + dt.Rows[0]["HRManagerEmail"].ToString();
                                Approvals.Value = "Dept Head Approval,HR Representative Approval,HR Head Approval";
                            }
                        }
                    }
