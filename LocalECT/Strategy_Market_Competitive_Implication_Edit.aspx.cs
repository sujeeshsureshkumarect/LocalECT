...
namespace LocalECT
{
  public partial class CS_Market_Competitive_Implication_Edit : System.Web.UI.Page
  {
    ...
    {
      SqlCommand cmd = new SqlCommand("select * from CS_Market_Competitive_Implication  where iSerial=@iLink", sc);
      ...
      try
      {
        ...
        if (dt.Rows.Count > 0)
        {
          txt_Implication.Text = dt.Rows[0]["sMarketCompetitiveImplication"].ToString();
        }
      }
      catch (Exception ex)
      {
