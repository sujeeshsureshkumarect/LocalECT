<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Initiative_Maturity.aspx.cs" Inherits="LocalECT.CS_Initiative_Maturity" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-dashboard"></i>  Initiative Maturity</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                               <a href="Strategy_Initiative_Maturity_Create" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New Initiative Maturity</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group" style="text-align:center">
                                                         ...
                                                         <div class="dropdown-menu" >                                                             
                                                            <a href="Strategy_Initiative_Maturity_Edit.aspx?id=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
