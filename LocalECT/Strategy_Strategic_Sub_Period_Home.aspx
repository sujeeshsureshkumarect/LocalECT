<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_Sub_Period_Home.aspx.cs" Inherits="LocalECT.Strategy_Strategic_Sub_Period_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Strategic Sub Period</h2>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Strategic Sub Period</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" width="300px">Strategic Period</th>                                                                                       
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">Order</th>                                                                                       
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">Strategy Version</th>                                                                                       
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_Strategic_Sub_Period_Update.aspx?id=<%#Eval("iPeriod")%>&sid=<%#Eval("iSerial")%>&sver=<%#Eval("iStrategyVersion")%>" class="dropdown-item">Edit</a>                                                                                                                     
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
