<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_Task_Detail_Home.aspx.cs" Inherits="LocalECT.Strategy_Strategic_Task_Detail_Home" MasterPageFile="~/LocalECT.Master"%>
                                    ...
                                    <div class="x_panel">
                                        <div class="x_title">
                                            ...
                                            <ul class="nav navbar-right panel_toolbox">                                                
                                                ...
                                                <asp:LinkButton ID="LinkButton1" runat="server" style="float:right;" CssClass="btn btn-success btn-sm" OnClick="LinkButton1_Click"><i class="fa fa-arrow-circle-left"></i> Tasks</asp:LinkButton>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Task Status</th>
                                            <%--<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Submitted Evidence</th>                                            --%>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                                                                                          
                                                             <a href="Strategy_Strategic_Task_Detail_Update.aspx?id=<%#Eval("iInitiative")%>&sid=<%#Eval("iTask")%>&did=<%#Eval("iSerial")%>&t=v" class="dropdown-item">View</a> 
                                                             <a href="Strategy_Strategic_Task_Detail_Update.aspx?id=<%#Eval("iInitiative")%>&sid=<%#Eval("iTask")%>&did=<%#Eval("iSerial")%>&t=e" class="dropdown-item">Edit</a>                                                              
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
