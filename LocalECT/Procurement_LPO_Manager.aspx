                                                  ...
                                                  <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">
                                                             ...
                                                             <asp:LinkButton ID="lnk_Delete" runat="server" CssClass="dropdown-item" CommandArgument='<%#Eval("iLPO")%>' oncommand="PrintBTN_Command"><i class="fa fa-print"></i> Print</asp:LinkButton>
                                                              <asp:LinkButton ID="LinkButton1" runat="server" CssClass="dropdown-item" CommandArgument='<%#Eval("iLPO")%>' oncommand="PrintWOFooter_Command"><i class="fa fa-print"></i> Print (Without Header & Footer)</asp:LinkButton>
                                                         </div>
                                                     </div>
                                                      </td>
                                             </tr>
