<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Survey_Form.aspx.cs" Inherits="LocalECT.CS_Survey_Form" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-dashboard"></i> Survey Form</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                               <a href="Strategy_Survey_Form_Create" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New Survey Form</a>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Survey Form Reference</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Survey Name</th>
                                                   ...
                                                   <td><%#Eval("sSurveyName")%></td>
                                                    ...
                                                    <div class="btn-group" style="text-align:center">
                                                         ...
                                                         <div class="dropdown-menu" >                                                             
                                                            <a href="Strategy_Survey_Form_Edit.aspx?id=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
