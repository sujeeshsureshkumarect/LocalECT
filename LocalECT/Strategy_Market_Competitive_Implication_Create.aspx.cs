...
namespace LocalECT
{
  public partial class CS_Market_Competitive_Implication_Create : System.Web.UI.Page
  {
    ...
    protected void btn_Create_Click(object sender, EventArgs e)
    {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_Market_Competitive_Implication values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
      cmd.Parameters.AddWithValue("@sProg", txt_Implication.Text.Trim());
      ...
      try
      {
        ...
        lbl_Msg.Text = "Market Competitive Implication Created Successfully";
        div_msg.Visible = true;

        txt_Implication.Text = "";
    ...
    {
      Response.Redirect("Strategy_Market_Competitive_Implication");
    }
  }
}
