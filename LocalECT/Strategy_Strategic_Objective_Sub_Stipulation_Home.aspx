<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_Objective_Sub_Stipulation_Home.aspx.cs" Inherits="LocalECT.Strategy_Strategic_Objective_Sub_Stipulation_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Manage MOE Re-licensure Sub Stipulation</h2>
                                            <ul class="nav navbar-right panel_toolbox">                                                
                                                ...
                                                <a href="Strategy_Strategic_Objective_Home.aspx" style="float:right;" class="btn btn-success btn-sm"><i class="fa fa-arrow-circle-left"></i> Strategic Objective</a>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Strategic Objective</th>                                                                                        
