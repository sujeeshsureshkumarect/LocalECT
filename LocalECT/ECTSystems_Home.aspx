<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECTSystems_Home.aspx.cs" Inherits="LocalECT.ECTSystems_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        color:#444444;
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-dashboard"></i> ECT Systems Dashboard</h2>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat red-intense">
                                ...
                                <%-- <a class="more" href="javascript:void(0);"> View More <i class="glyphicon glyphicon-circle-arrow-right" style="font-size:12px"></i> </a>--%>
                                            ...
                                            <a href="ECTSystems_Create.aspx" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New System</a>
                                            <div class="clearfix"></div>
                                     ...
                                     <asp:Repeater ID="RepterDetails" runat="server">
                                             ...
                                             <table id='datatable' class='table table-striped table-bordered' style='width: 100%'>
                                                 <thead>
                                                     <tr class='headings'>
                                                         ...
                                                         <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending">System Name</th>
                                         ...
                                         <ItemTemplate>
                                             <tr>
                                                 ...
                                                 <td><a href="ECTSystems_Update.aspx?seqid=<%#Eval("SeqID")%>" class="btn btn-success btn-sm">View / Edit</a>
