<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_Theme_Home.aspx.cs" Inherits="LocalECT.Strategy_Strategic_Theme_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Strategic Theme</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <a href="Strategy_Strategic_Theme_Update.aspx" style="float:right;" class="btn btn-success btn-sm" runat="server" id="lnk_Create"><i class="glyphicon glyphicon-plus"></i> Create New Strategic Theme</a>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Theme Code</th>                                                                                        
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Theme Desc</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">  
                                                            <%-- <a href="Strategy_Strategic_Theme_Update.aspx?id=<%#Eval("iSerial")%>&t=v" class="dropdown-item">View</a> 
                                                             <a href="Strategy_Strategic_Theme_Update.aspx?id=<%#Eval("iSerial")%>&t=e" class="dropdown-item">Edit</a> --%>
