<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Digital_Use_Case_Create.aspx.cs" Inherits="LocalECT.Digital_Use_Case_Create" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-plus"></i> Create New Digital Use Case</h2>
                                        ...
                                        <asp:Label ID="lbl_Msg" runat="server" Text="Link Created Successfully" Visible="true" Font-Bold="true" Font-Size="16px"></asp:Label>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                 ...
                                                 <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <asp:TextBox ID="txt_UseCase" runat="server" CssClass="form-control" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="*Digital Use Case Required" ControlToValidate="txt_UseCase" ForeColor="Red" ValidationGroup="no">
