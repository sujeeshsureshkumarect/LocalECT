<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Digital_Transformation_Create.aspx.cs" Inherits="LocalECT.Digital_Transformation_Create" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-plus"></i> Create New Digital Transformation Program</h2>
                                        ...
                                        <asp:Label ID="lbl_Msg" runat="server" Text="Link Created Successfully" Visible="true" Font-Bold="true" Font-Size="16px"></asp:Label>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                 ...
                                                 <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <asp:TextBox ID="txt_Program" runat="server" CssClass="form-control" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="*Digital Transformation Program Required" ControlToValidate="txt_Program" ForeColor="Red" ValidationGroup="no">
