                                ...
                                <table style="width: 100%; border: 1px solid #e5e5e5" align="center" class="details">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                          ...
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_Date" Display="Dynamic" ValidationGroup="no" ErrorMessage="Date Required " ForeColor="#CC3300"></asp:RequiredFieldValidator>
