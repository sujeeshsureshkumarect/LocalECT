...
namespace LocalECT
{
    public partial class CS_Survey_Form_Edit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentRole"] != null)
                {
                    ...
                    if (!IsPostBack)
                    {
                        if (LibraryMOD.isRoleAuthorized(InitializeModule.enumPrivilegeObjects.Survey_Form,
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from CS_Survey_Form where iSerial=@iLink", sc);
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    txt_Ref.Text = dt.Rows[0]["sSurveyFormReference"].ToString();
                    txt_sName.Text = dt.Rows[0]["sSurveyName"].ToString();
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("update  set sSurveyFormReference=@sRef,sSurveyName=@sname,dUpdated=@dUpdated,sUpdatedBy=@sUpdatedby where iSerial=@iLink", sc);
