...
<table  bgcolor="#EFF3FB" style="width:100%;">
    <tr>
        ...
        <td>
                                        <asp:TextBox ID="txt1" runat="server" Width="100px" 
        ...
        <td colspan="2">
                                        <asp:TextBox ID="txt2" runat="server" Width="260px" 
    ...
    <tr>
        ...
        <td>
                                        <asp:TextBox ID="txt4" runat="server" Width="100px" TabIndex="4"></asp:TextBox>
                                     </td>
        <td align="right">
                                        &nbsp;</td>
    </tr>
    <tr>
        ...
        <td colspan="3">
                                        <asp:TextBox ID="txt5" runat="server" Width="450px" 
                                            ontextchanged="txt2_TextChanged" TabIndex="1"></asp:TextBox>
                                     </td>
        <td align="left">
