<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_IRQA_Recommendation_Update.aspx.cs" Inherits="LocalECT.Strategy_IRQA_Recommendation_Update" MasterPageFile="~/LocalECT.Master"%>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            ...
                                            <ul class="nav navbar-right panel_toolbox">
                                                ...
                                                <asp:LinkButton ID="lnk_Create" runat="server" style="float:right;" CssClass="btn btn-success btn-sm" OnClick="lnk_Create_Click"><i class="fa fa-arrow-circle-left"></i> Manage IRQA Recommendation</asp:LinkButton>
                                    ...
                                    <div class="alert alert-success alert-dismissible " role="alert" runat="server" id="div_Alert">
                                        ...
                                        <asp:Label ID="lbl_Msg" runat="server" Text="IRQA Recommendation Created Successfully" Visible="true" Font-Bold="true" Font-Size="16px"></asp:Label>
                                    </div>
                                </div>
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="*IRQARecommendation Required" ControlToValidate="txt_IRQARecommendation" ForeColor="Red" ValidationGroup="no">
