...
namespace LocalECT
{
    public partial class HR_Loan_Application : System.Web.UI.Page
    {
        ...
        public void sentdatatoSPLIst()
        {
            ...
            myItem["Contact"] = "--";
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceName.Text + "<br/><b>Faculty:</b>" + Faculty.Text + "<br/><b>Relocation Loan Amount Requested (Not exceeding One month salary): </b> " + LoanAmount.Text + "<br/><b>Terms & Conditions:</b>" + Conditions.Text + "<br/><b>Agreed:</b>" + Agreement.SelectedValue.Trim() + "<br/><b>Signature:</b>" + Signature.Text + "<br/><b>Date:</b>" + txt_Date.Text + "<br/>";
