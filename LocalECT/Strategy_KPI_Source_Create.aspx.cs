...
namespace LocalECT
{
    public partial class CS_KPI_Source_Create : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_KPI_Source values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
            ...
            try
            {
                ...
                lbl_Msg.Text = "KPI Source Created Successfully ";
                div_msg.Visible = true;
