<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Customer_Experience_Evidence_Category_Home.aspx.cs" Inherits="LocalECT.Strategy_Customer_Experience_Evidence_Category_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Customer Experience Evidence Category</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <a href="Strategy_Customer_Experience_Evidence_Category_Update.aspx" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New Customer Experience Evidence Category</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_Customer_Experience_Evidence_Category_Update.aspx?id=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
                                                             <a class="dropdown-item" href="Strategy_Customer_Experience_Evidence_Sub_Category_Home.aspx?id=<%#Eval("iSerial")%>">Manage Customer Experience Evidence Sub Category</a>                                                          
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
