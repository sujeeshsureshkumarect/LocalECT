<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Risk_Management_Registry_Framework_Home.aspx.cs" Inherits="LocalECT.Strategy_Risk_Management_Registry_Framework_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Risk Management Registry Framework</h2>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" width="300px">Framework</th>                                                                                       
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_Risk_Management_Registry_Framework_Update.aspx?id=<%#Eval("iFramework")%>&sid=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>                                                                                                                     
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
