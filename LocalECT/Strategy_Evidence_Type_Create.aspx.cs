...
namespace LocalECT
{
    public partial class CS_Evidence_Type_Create : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_Evidence_Type values(@sEvi,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
            ...
            try
            {
                ...
                lbl_Msg.Text = "Evidence Type Created Successfully ";
                div_msg.Visible = true;
