<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Risk_Management_Framework_Home.aspx.cs" Inherits="LocalECT.Strategy_Risk_Management_Framework_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Risk Management Framework</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <a href="Strategy_Risk_Management_Framework_Update.aspx" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_Risk_Management_Framework_Update.aspx?id=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
                                                             <a class="dropdown-item" href="Strategy_Risk_Management_Registry_Framework_Home.aspx?id=<%#Eval("iSerial")%>">Manage Registry Framework</a>                                                          
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
