...
namespace LocalECT
{
  public partial class CS_Initiative_Maturity_Create : System.Web.UI.Page
  {
    ...
    {
      SqlCommand cmd = new SqlCommand("insert into CS_Initiative_Maturity values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
      ...
      try
      {
        ...
        lbl_Msg.Text = "Initiative Maturity Created Successfully";
