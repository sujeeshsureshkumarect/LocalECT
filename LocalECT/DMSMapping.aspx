<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DMSMapping.aspx.cs" Inherits="LocalECT.DMSMapping" MasterPageFile="~/LocalECT.Master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>
                        <a href="DMSMapping">&nbsp;Document Management System Mapping </a>
                    </h3>
                </div>
                <style>
                    .breadcrumb {
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-folder-open"></i> Document Management System Mapping</h2>
