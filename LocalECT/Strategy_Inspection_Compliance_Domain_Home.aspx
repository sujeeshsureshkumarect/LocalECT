<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Inspection_Compliance_Domain_Home.aspx.cs" Inherits="LocalECT.Strategy_Inspection_Compliance_Domain_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Inspection Compliance Domain</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                ...
                                                <asp:LinkButton ID="lnk_Create" runat="server" style="float:right;" CssClass="btn btn-success btn-sm" OnClick="lnk_Create_Click"><i class="glyphicon glyphicon-plus"></i> Create New Inspection Compliance Domain</asp:LinkButton>
