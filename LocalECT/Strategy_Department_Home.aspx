<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Department_Home.aspx.cs" Inherits="LocalECT.Strategy_Department_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Department</h2>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending">Dept ID</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" width="300px">Dept Name</th>                                                                                       
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending">Dept Abrv.</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending">Job ID of Dept Head</th> 
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending">Job Title of Dept Head</th> 
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_Department_Update.aspx?id=<%#Eval("DepartmentID")%>" class="dropdown-item">Edit</a>
                                                             <a class="dropdown-item" href="Strategy_Department_Manage_Sections.aspx?id=<%#Eval("DepartmentID")%>">Manage Sections</a>                                                          
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
