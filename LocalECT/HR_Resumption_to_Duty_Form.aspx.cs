...
namespace LocalECT
{
    public partial class HR_Resumption_to_Duty_Form : System.Web.UI.Page
    {
        ...
        {
            DateTime StartDate = DateTime.Parse(Leave_StartDate.Text);
            DateTime EndDate = DateTime.Parse(Leave_EndDate.Text);
        ...
        public void sentdatatoSPLIst()
        {
            ...
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + "<br/><b>Department:</b> " + lbl_Dept.Text + "<br/><b>Position:</b> " + Lbl_Position.Text + "<br/><b>Return Date:</b> " + ReturnDate.Text + "<br/><b>Vacation Approval Start Date:</b>" + Leave_StartDate.Text + "<br/><b>Vacation Approval ends Date:</b> " + Leave_EndDate.Text + "<br/><b>Signature:</b>" + Sig.Text + "<br/><b>Date:</b>" + sDate.Text + "<br/>";
