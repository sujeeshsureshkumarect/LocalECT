<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Initiative_Priority.aspx.cs" Inherits="LocalECT.CS_Initiative_Priority" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-dashboard"></i> Initiative Priority</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                               <a href="Strategy_Initiative_Priority_Create" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New Priority</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group" style="text-align:center">
                                                         ...
                                                         <div class="dropdown-menu" >                                                             
                                                            <a href="Strategy_Initiative_Priority_Edit.aspx?id=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
