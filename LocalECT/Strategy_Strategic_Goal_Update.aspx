<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_Goal_Update.aspx.cs" Inherits="LocalECT.Strategy_Strategic_Goal_Update" MasterPageFile="~/LocalECT.Master"%>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            ...
                                            <ul class="nav navbar-right panel_toolbox">
                                                <%--<a href="Strategy_Strategic_Goal_Home.aspx" style="float:right;" class="btn btn-success btn-sm" title="Back"><i class="fa fa-arrow-circle-left"></i> Strategic Goal</a>--%>
                                                <asp:LinkButton ID="lnk_Back" runat="server" style="float:right;" CssClass="btn btn-success btn-sm" title="Back" OnClick="lnk_Back_Click"><i class="fa fa-arrow-circle-left"></i> Strategic Goal</asp:LinkButton>
                                    ...
                                    <div class="alert alert-success alert-dismissible " role="alert" runat="server" id="div_Alert">
                                        ...
                                        <asp:Label ID="lbl_Msg" runat="server" Text="Strategic Goal Created Successfully" Visible="true" Font-Bold="true" Font-Size="16px"></asp:Label>
                                    </div>
                                </div>
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <div class="form-group ">
                                                        <label>Strategic Goal ID *</label>
                                                        <asp:TextBox ID="txt_StrategicGoalID" runat="server" CssClass="form-control"></asp:TextBox>
                                                        <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="*Strategic Goal ID Required" ControlToValidate="txt_StrategicGoalID" ForeColor="Red" ValidationGroup="no">
                                                        </asp:RequiredFieldValidator>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label>Strategic Goal Description *</label>
                                                        <asp:TextBox ID="txt_StrategicGoalDesc" runat="server" CssClass="form-control" TextMode="MultiLine" Height="100px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="*Strategic Goal Description Required" ControlToValidate="txt_StrategicGoalDesc" ForeColor="Red" ValidationGroup="no">
                                                        </asp:RequiredFieldValidator>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label>MOE Re-licensure Stipulation ID *</label>
                                                        <asp:DropDownList ID="drp_StipulationID" runat="server" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label>Inspection Compliance Standard ID *</label>
                                                        <asp:DropDownList ID="drp_InspectionComplianceStandardID" runat="server" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label>Order *</label>
