...
namespace LocalECT
{
    public partial class CS_Strategic_KPI_Status_Create : System.Web.UI.Page
    {
        ...
        protected void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into CS_Strategic_KPI_Status values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
            ...
            try
            {
                ...
                lbl_Msg.Text = "KPI Status Created Successfully ";
                div_msg.Visible = true;
