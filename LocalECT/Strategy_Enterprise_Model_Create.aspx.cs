...
namespace LocalECT
{
  public partial class Strategy_Enterprise_Model_Create : System.Web.UI.Page
  {
    ...
    {
      SqlCommand cmd = new SqlCommand("insert into CS_Enterprise_Model values(@sProg,@dAdded,@sAddedby,@dUpdated,@sUpdatedby)", sc);
      ...
      try
      {
        ...
        lbl_Msg.Text = "Enterprise Model Created Successfully ";
