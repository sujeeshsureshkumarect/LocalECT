<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Inspection_Compliance_Standard_Home.aspx.cs" Inherits="LocalECT.Strategy_Inspection_Compliance_Standard_Home" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-sitemap"></i> Inspection Compliance Standard</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <a href="Strategy_Inspection_Compliance_Standard_Update.aspx" style="float:right;" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create New Inspection Compliance Standard</a>
                                ...
                                <table id="example" class="table table-striped table-bordered" role="grid" aria-describedby="datatable_info" style='width: 100%'>
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" width="300px">Inspection Compliance Standard Description</th>                                                                                       
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="btn-group">
                                                         ...
                                                         <div class="dropdown-menu">                                                             
                                                             <a href="Strategy_Inspection_Compliance_Standard_Update.aspx?sid=<%#Eval("iSerial")%>" class="dropdown-item">Edit</a>
                                                             <a class="dropdown-item" href="Strategy_Inspection_Compliance_Domain_Home.aspx?sid=<%#Eval("iSerial")%>">Manage Inspection Compliance Domain</a>                                                          
                                                         </div>
                                                     </div>
                                                   </td>                                                    
                                                </tr>                                        
