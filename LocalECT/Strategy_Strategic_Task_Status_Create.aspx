<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_Task_Status_Create.aspx.cs" Inherits="LocalECT.CS_Strategic_Task_Status_Create" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-plus"></i> Create Strategic Task Status</h2>
                                    ...
                                    <div class="alert alert-success alert-dismissible " role="alert" runat="server" id="div_Alert">
                                        ...
                                        <asp:Label ID="lbl_Msg" runat="server" Text="Strategic Task Status Created Successfully" Visible="true" Font-Bold="true" Font-Size="16px"></asp:Label>
                                    </div>
                                </div>
                                            <div class="col-md-12 col-sm-12">
