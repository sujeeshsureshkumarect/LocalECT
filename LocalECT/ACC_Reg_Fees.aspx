<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ACC_Reg_Fees.aspx.cs" Inherits="LocalECT.ACC_Reg_Fees" MasterPageFile="~/LocalECT.Master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>
                        <a href="#">&nbsp;Accounting /</a>
                      <a href="ACC_Reg_Fees">&nbsp;Reg Fees </a>
                    </h3>
                </div>
                <style>
                    .breadcrumb {
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-bar-chart"></i> Registered Fees</h2>
                                ...
                                <div class="row">  
                                  ...
                                  <div class="col-sm-2 col-md-2 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <asp:ListItem Text="Summary" Value="1" Selected="True"/>
                                            <asp:ListItem Text="Details" Value="2" />
                                        </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
