<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRService_MyRequests.aspx.cs" Inherits="LocalECT.HRService_MyRequests" MasterPageFile="~/LocalECT.Master"%>
                        ...
                        <div class="">
                            <div class="page-title">
                                <div class="title_left">
                                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>                       
                        <a href="HRService_MyRequests">&nbsp;My HR Service Requests</a>
                    </h3>
                                </div>
                                <style>
                                     .breadcrumb {
            ...
            font-size: 100%;
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-user"></i> My HR Service Requests <asp:LinkButton ID="lnk_refresh" runat="server" CssClass="btn btn-success btn-sm" OnClick="lnk_refresh_Click" ToolTip="Refresh"><i class="fa fa-refresh"></i></asp:LinkButton></h2>
...
white-space: nowrap;
       ...
       if (table != null) {
           for (var i = 1; i < table.rows.length; i++) {              
               ...
               if (status == "Approval process completed successfully") {
                   table.rows[i].cells[2].innerHTML = '<span class="badge badge-success">Approval process completed successfully</span>';
               }
               else {
                   table.rows[i].cells[2].innerHTML = '<span class="badge badge-warning">' + status + '</span>';
               } 
               if (status.indexOf('Rejected ') >= 0) {
                   table.rows[i].cells[2].innerHTML = '<span class="badge badge-danger">' + status + '</span>';
               }
           }
       }
                                         </script>
