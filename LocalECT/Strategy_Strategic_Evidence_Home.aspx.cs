...
namespace LocalECT
{
    public partial class Strategy_Strategic_Evidence_Home : System.Web.UI.Page
    {
        ...
        public void bindStrategic_Evidence()
        {
            ...
            {
                sSQL += "where CS_Strategic_Evidence.iSerial in (";
                ...
                string sSQL1 = " SELECT CS_Strategic_Evidence.iSerial FROM CS_Strategic_Evidence INNER JOIN Lkp_Department ON CS_Strategic_Evidence.iDepartment = Lkp_Department.DepartmentID INNER JOIN Lkp_Section ON CS_Strategic_Evidence.iSection = Lkp_Section.SectionID WHERE (Lkp_Department.ManagerID = " + Session["EmployeeID"].ToString() + ") OR (Lkp_Section.ManagerID = " + Session["EmployeeID"].ToString() + "))";
