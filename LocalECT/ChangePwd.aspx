<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePwd.aspx.cs" Inherits="LocalECT.ChangePwd" MasterPageFile="~/LocalECT.Master"%>
    ...
    <div class="right_col" role="main">
                   ...
                   <br />
                        <asp:LinkButton ID="LinkSave" runat="server"  onclick="ButSubmit_Click" 
                           CssClass="btn btn-success btn-sm" ValidationGroup="pwd">Save</asp:LinkButton>
                    <br />
