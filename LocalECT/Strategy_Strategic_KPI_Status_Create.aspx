<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Strategy_Strategic_KPI_Status_Create.aspx.cs" Inherits="LocalECT.CS_Strategic_KPI_Status_Create" MasterPageFile="~/LocalECT.Master" %>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><i class="fa fa-plus"></i> Create KPI Status</h2>
                                    ...
                                    <div class="alert alert-success alert-dismissible " role="alert" runat="server" id="div_Alert">
                                        ...
                                        <asp:Label ID="lbl_Msg" runat="server" Text="KPI Status Created Successfully" Visible="true" Font-Bold="true" Font-Size="16px"></asp:Label>
                                    </div>
                                </div>
                                            <div class="col-md-12 col-sm-12">
                                                 ...
                                                 <div class="col-md-6 col-sm-6">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="* Required" ControlToValidate="txt_Status" ForeColor="Red" ValidationGroup="no">
