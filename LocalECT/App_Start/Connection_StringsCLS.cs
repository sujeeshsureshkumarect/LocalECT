    ...
    public Connection_StringCLS(InitializeModule.EnumCampus Campus)
    {
        switch (Campus)
        {
            ...
            case InitializeModule.EnumCampus.ECTNew:
                ...
                break;
            case InitializeModule.EnumCampus.ACMS:
                Conn_string = "Data Source=acs-server;Initial Catalog=aeosdb;Persist Security Info=True;User ID=TA_READER;Password=ECT_ta@1234";
                break;
