...
public class HRGrades
{
//Creation Date: 03/10/2010 7:39 PM
//Programmer Name : 
//-----Decleration --------------
#region "Decleration"
...
public class HRGradesDAL : HRGrades
{
#region "Decleration"
...
#endregion
public List< HRGrades> GetGrades(InitializeModule.EnumCampus Campus ,string sCondition,bool isDeafaultIncluded)
{
...
List<HRGrades> results = new List<HRGrades>();
try
{
//Default Value
HRGrades myHRGrades = new HRGrades();
if (isDeafaultIncluded)
{
//Change the code here
myHRGrades.GradeID = 0;
myHRGrades.GradeDescEn = "Select Grades ...";
results.Add(myHRGrades);
}
while (reader.Read())
{
myHRGrades = new HRGrades();
...
{
myHRGrades.GradeID = int.Parse(reader[LibraryMOD.GetFieldName( GradeIDFN) ].ToString());
}
myHRGrades.GradeDescEn =reader[LibraryMOD.GetFieldName( GradeDescEnFN) ].ToString();
myHRGrades.GradeDescAr =reader[LibraryMOD.GetFieldName( GradeDescArFN) ].ToString();
if (reader[LibraryMOD.GetFieldName(CirclesNoFN)].Equals(DBNull.Value))
{
myHRGrades.CirclesNo = 0;
}
else
{
myHRGrades.CirclesNo = int.Parse(reader[LibraryMOD.GetFieldName( CirclesNoFN) ].ToString());
}
myHRGrades.MinimumSalary =reader[LibraryMOD.GetFieldName( MinimumSalaryFN) ].ToString();
myHRGrades.MaximumSalary =reader[LibraryMOD.GetFieldName( MaximumSalaryFN) ].ToString();
myHRGrades.BasicSalary =reader[LibraryMOD.GetFieldName( BasicSalaryFN) ].ToString();
myHRGrades.IncrementAmount =reader[LibraryMOD.GetFieldName( IncrementAmountFN) ].ToString();
if (reader[LibraryMOD.GetFieldName(IsGradeTypeFN)].Equals(DBNull.Value))
{
myHRGrades.IsGradeType = 0;
}
else
{
myHRGrades.IsGradeType = int.Parse(reader[LibraryMOD.GetFieldName( IsGradeTypeFN) ].ToString());
}
if (reader[LibraryMOD.GetFieldName(GradeParentFN)].Equals(DBNull.Value))
{
myHRGrades.GradeParent = 0;
}
else
{
myHRGrades.GradeParent = int.Parse(reader[LibraryMOD.GetFieldName( GradeParentFN) ].ToString());
}
if (reader[LibraryMOD.GetFieldName(IsValueFN)].Equals(DBNull.Value))
{
myHRGrades.IsValue = 0;
}
else
{
myHRGrades.IsValue = int.Parse(reader[LibraryMOD.GetFieldName( IsValueFN) ].ToString());
}
if (reader[LibraryMOD.GetFieldName(NextGradeFN)].Equals(DBNull.Value))
{
myHRGrades.NextGrade = 0;
}
else
{
myHRGrades.NextGrade = int.Parse(reader[LibraryMOD.GetFieldName( NextGradeFN) ].ToString());
}
if (reader[LibraryMOD.GetFieldName(CreationUserIDFN)].Equals(DBNull.Value))
{
myHRGrades.CreationUserID = 0;
}
else
{
myHRGrades.CreationUserID = int.Parse(reader[LibraryMOD.GetFieldName( CreationUserIDFN) ].ToString());
}
if (!reader[LibraryMOD.GetFieldName(CreationDateFN)].Equals(DBNull.Value))
{
myHRGrades.CreationDate = DateTime.Parse(reader[LibraryMOD.GetFieldName( CreationDateFN) ].ToString());
}
if (reader[LibraryMOD.GetFieldName(LastUpdateUserIDFN)].Equals(DBNull.Value))
{
myHRGrades.LastUpdateUserID = 0;
}
else
{
myHRGrades.LastUpdateUserID = int.Parse(reader[LibraryMOD.GetFieldName( LastUpdateUserIDFN) ].ToString());
}
if (!reader[LibraryMOD.GetFieldName(LastUpdateDateFN)].Equals(DBNull.Value))
{
myHRGrades.LastUpdateDate = DateTime.Parse(reader[LibraryMOD.GetFieldName( LastUpdateDateFN) ].ToString());
}
myHRGrades.PCName =reader[LibraryMOD.GetFieldName( PCNameFN) ].ToString();
myHRGrades.NetUserName =reader[LibraryMOD.GetFieldName( NetUserNameFN) ].ToString();
 results.Add(myHRGrades);
}
}
catch (Exception ex)
...
public List< HRGrades > GetList(InitializeModule.EnumCampus Campus, string sCondition, bool isDeafaultIncluded)
{
Connection_StringCLS MyConnection_string = new Connection_StringCLS(Campus);
...
Conn.Open();
string sql = "";
HRGrades theHRGrades = new HRGrades();
//'Updates the  table
switch(iMode) 
  {
...
List<HRGrades> myGradess = new List<HRGrades>();
try
{
myGradess = GetGrades(InitializeModule.EnumCampus.ECTNew,sCondition,false);
...
DataRow dr;
for (int i = 0; i < myGradess.Count; i++)
{
dr = dt.NewRow();
  dr[1] = myGradess[i].GradeID;
  dr[2] = myGradess[i].GradeDescEn;
  dr[3] = myGradess[i].GradeDescAr;
  dt.Rows.Add(dr);
}
dt.AcceptChanges();
dv.Table = dt;
...
public class HRGradesCls : HRGradesDAL
{
#region "Decleration"
