...
public class UserDAL : User
{
        ...
        int LastUpdateUserID, DateTime LastUpdateDate, string PCName, string NetUserName)
    {
        ...
        try
        {
            ...
            if (string.IsNullOrEmpty(GradesPCName))
            {
                GradesPCName = "---";
            }
            Cmd.Parameters.Add(new SqlParameter("@UserNo", UserNo));
...
public class UserCls : UserDAL
{
    ...
    public bool UpdateEmailPassword(InitializeModule.EnumCampus Campus, int iUserNo,string sPassword)
    {
        Connection_StringCLS myConnection_String = new Connection_StringCLS(Campus);
        SqlConnection Conn = new SqlConnection(myConnection_String.Conn_string);
        Conn.Open();
        ...
        {
            //Change the advisor
            string sSQL = "UPDATE Cmn_User SET EmailPassword='" + sPassword + "'";
