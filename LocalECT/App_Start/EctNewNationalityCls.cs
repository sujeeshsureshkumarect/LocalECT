...
public class EctNewNationality
{
    //Creation Date: 15/03/2010 09:07:01 ص
    //Programmer Name : En.Hazem Galal
    //-----Decleration --------------
    #region "Decleration"
...
public class EctNewNationalityDAL : EctNewNationality
{
    #region "Decleration"
    ...
    #endregion
    public List<EctNewNationality> GetNationality(InitializeModule.EnumCampus Campus, string sCondition, bool isDeafaultIncluded)
    {
        ...
        List<EctNewNationality> results = new List<EctNewNationality>();
        try
        {
            //Default Value
            EctNewNationality myNationality = new EctNewNationality();
            ...
            while (reader.Read())
            {
                myNationality = new EctNewNationality();
    ...
    public int UpdateNationality(InitializeModule.EnumCampus Campus, int iMode, int NationalityID, string NationalityDescEn, string NationalityDescAr, int GroupID, int NationalityMaleID, int NationalityFemaleID, int CreationUserID, DateTime CreationDate, int LastUpdateUserID, DateTime LastUpdateDate, string PCName, string NetUserName)
    {
        ...
        try
        {
            Conn.Open();
            string sql = "";
            EctNewNationality theNationality = new EctNewNationality();
            //'Updates the  table
            switch (iMode)
            {
    ...
    public DataView GetDataView(bool isFromRole, int PK, string sCondition)
    {
        ...
        List<EctNewNationality> myNationalitys = new List<EctNewNationality>();
        try
        {
            myNationalitys = GetNationality(InitializeModule.EnumCampus.ECTNew, sCondition, false);
            DataColumn col1 = new DataColumn("NationalityID", Type.GetType("int"));
            dt.Columns.Add(col1);
            DataColumn col2 = new DataColumn("NationalityDescEn", Type.GetType("nvarchar"));
            dt.Columns.Add(col2);
            DataColumn col3 = new DataColumn("NationalityDescAr", Type.GetType("nvarchar"));
            dt.Columns.Add(col3);
            ...
            for (int i = 0; i < myNationalitys.Count; i++)
            {
                ...
                dr[2] = myNationalitys[i].NationalityDescEn;
                dr[3] = myNationalitys[i].NationalityDescAr;
                dt.Rows.Add(dr);
            }
            dt.AcceptChanges();
            dv.Table = dt;
...
public class EctNewNationalityCls : EctNewNationalityDAL
{
    #region "Decleration"
