<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ACC_Balance_Tracking.aspx.cs" Inherits="LocalECT.ACC_Balance_Tracking" MasterPageFile="~/LocalECT.Master" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>
                        <a href="#">&nbsp;Accounting /</a>
                      <a href="ACC_Balance_Tracking">&nbsp;Balance Tracking </a>
                    </h3>
                </div>
                <style>
                    .breadcrumb {
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-bar-chart"></i> Balance Tracking</h2>
                                ...
                                <div class="row">  
                                  ...
                                  <div class="col-sm-2 col-md-2 col-xs-12">
                                        <div class="form-group">
                                            <label>LTR > = </label>
                                            <div class="input-group">
                                                 <asp:DropDownList ID="ddlRegTermLTR" runat="server" CssClass="form-control">
