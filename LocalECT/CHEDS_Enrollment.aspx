<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CHEDS_Enrollment.aspx.cs" Inherits="LocalECT.CHEDS_Enrollment" MasterPageFile="~/LocalECT.Master"%>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="breadcrumb">
                        <a href="Home">Home /</a>
                        <a href="CHEDS_Enrollment">&nbsp;CHEDS Enrollment</a>
                    </h3>
                </div>
                <style>
                    .breadcrumb {
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-calendar"></i> CHEDS Enrollment</h2>
